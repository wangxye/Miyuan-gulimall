    ...
    >
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="200" label="操作">
        ...
        <template slot-scope="scope" style="width:200px">
          <el-button type="text" size="small" @click="previewHandle(scope.row.skuId,false)">预览</el-button>
          <el-button type="text" size="small" @click="previewHandle(scope.row.skuId,true)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.skuId,true)">删除</el-button>
          ...
          >
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="commentHandle">评论</el-dropdown-item>
...
import AddOrUpdate from "./sku-update";
export default {
  data() {
    return {
      catPathSub: null,
