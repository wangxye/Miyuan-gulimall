<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="spuDescription" header-align="center" align="center" label="描述" width="250"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          <el-button  v-if="scope.row.publishStatus == 1" type="text" size="small" @click="productdown(scope.row.id)">下架</el-button>
        </template>
      </el-table-column>
    </el-table>
